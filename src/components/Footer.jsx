        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-white/60 text-xs italic">
              "Diseñamos procesos de transformación organizacional que 
              integran estrategia, desarrollo humano y herramientas de 
            ...
            <div className="flex gap-3 mt-6">
              {[
                ...
                <a
                  ...
                  href="#"
                  aria-label={label}
                  className="w-10 h-10 bg-white/10 hover:bg-accent/30 rounded-lg flex items-center justify-center transition-colors duration-200"
          ...
          {/* Navigation */}
          <div>
            <h3 className="font-heading font-bold text-sm uppercase tracking-widest text-accent mb-5">
              Navegación
            </h3>
              ...
              {navLinks.map((link) => (
                <li key={link.id}>
                  <button
                    ...
                    className="text-white/70 hover:text-white text-sm transition-colors duration-200 hover:translate-x-1 inline-block transition-transform"
                  >
                    {link.label}
                  </button>
                </li>
          ...
          <div>
            ...
            <div className="mt-6">
              <button
                ...
                className="bg-accent hover:bg-accent-dark text-primary-500 font-semibold text-sm px-5 py-2.5 rounded-lg transition-colors duration-200"
              >
