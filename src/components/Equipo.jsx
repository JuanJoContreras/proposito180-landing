          ...
          {team.map((member, i) => (
            <div key={i} className="group rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 bg-white">
              <div className="relative overflow-hidden h-80">
                <img src={member.img} alt={member.name} className={'w-full h-full object-cover ' + member.imgPos + ' group-hover:scale-105 transition-transform duration-500'} />
          ...
          <div className="bg-gray-50 rounded-3xl p-8 shadow-inner overflow-x-auto">
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              <div className="flex flex-wrap justify-center gap-3 mb-3">
                <div className="flex items-center gap-1.5"><span className="w-3 h-3 rounded-sm bg-[#3d3580]" /><span className="text-gray-500 text-xs">Dirección / Metodología</span></div>
                ...
                <div className="flex items-center gap-1.5"><span className="w-3 h-3 rounded-sm bg-[#1b4332]" /><span className="text-gray-500 text-xs">Sector Público</span></div>
              </div>
            </div>
          </div>
        </div>
